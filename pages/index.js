  ...
  return (
    <div>
      <Head>
        ...
        <Script src="js/main05dd.js" strategy='beforeInterative'
          onLoad={() => {
            console.log('Main has loaded')
          }} />
        <Script src="js/main6669.js" strategy='beforeInterative'
          onLoad={() => {
            console.log('Main2 has loaded')
          }} />
        <Script src="js/contact.js" strategy='beforeInterative'
          onLoad={() => {
            console.log('Contact has loaded')
          }} />
      </Head>
